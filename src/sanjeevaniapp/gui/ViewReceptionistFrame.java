...
public class ViewReceptionistFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("View All Receptionist");
        ...
        jtEmpDetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "REC ID", "RECPTIONIST NAME", "GENDER"
            }
        ) {
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, 970, 320));
    ...
    private void loadEmployeeDetails() {
        try {
            List<ReceptionistPojo> recDetails = ReceptionistDao.getAllReceptionistDetails();
            if (recDetails .isEmpty()) {
                JOptionPane.showMessageDialog(null, "No Record Found");
                return;
            }
            for (ReceptionistPojo e : recDetails) {
