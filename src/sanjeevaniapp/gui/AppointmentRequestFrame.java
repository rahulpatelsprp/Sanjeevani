...
public class AppointmentRequestFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 20, 620, 70));
    ...
    private void loadPatientDetails() {
        try {
            ...
            appList = AppointmentDao.getAllAppointmentByDoctorName(UserProfile.getUserName(),"REQUEST");
            if (appList.isEmpty()) {
